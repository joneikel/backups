...
class __Mustache_2489c3fbc3619aa111867351e97f7489 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if (empty($value)) {
            ...
            $buffer .= $this->section6b4f80a22bcd4916c685b66c934c5c09($context, $indent, $value);
...
';
    ...
    private function section6b4f80a22bcd4916c685b66c934c5c09(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '    <a class="nav-link" id="drop-down-';
